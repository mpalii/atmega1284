...
- Examine the voltage on the microcontroller pins with multimeter, and record the obtained values in the file (*./report/pin_state.ods*).  
...
<div align="center">
  <img src="circuitry/breadboard.jpg">
</div>
