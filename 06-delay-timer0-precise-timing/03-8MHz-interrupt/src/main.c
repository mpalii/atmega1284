/**
 * @author Maksym Palii
 * @brief Timer 0 usage example, 100kHz generator, 8MHz frequency
 * @date 2026 August 21
 */
...
/* (1 (prescaler) * 40 (OCR0A + 1)) / 8_000_000 MHz = 0.000005Sec = 5uSec   */
/****************************************************************************/
void init_timer_0(void)
{	
    ...
    OCR0A = 39;             // Set the compare register to 40 ticks (zero based)
