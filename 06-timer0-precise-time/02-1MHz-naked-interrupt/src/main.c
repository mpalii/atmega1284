/**
 * @author Maksym Palii
 * @brief Timer 0 usage example, 25kHz generator, 1MHz frequency
 * @version 1.0
...
/* (1 (prescaler) * 20 (OCR0A + 1)) / 1_000_000 MHz = 0.00002Sec = 20uSec   */
/****************************************************************************/
void init_timer_0(void)
{	
    ...
    OCR0A = 19;             // Set the compare register to 20 ticks (zero based)
