...
- task 4 - 0.5Hz frequency beacon flasher;
- task 5 - button handler, enable or disable double speed flashing frequency in task 3.

Pin A0 is toggling right at the beginning of timer 0 compare and match ISR handler.
