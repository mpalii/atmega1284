...
#define sbi_ddr(GPIO)           \
    __asm__ volatile ("sbi %0, %1" :: "I" (_DDR_ADDRESS(GPIO) - __SFR_OFFSET), "I" (GPIO & _GPIO_PIN_MASK))
#define cbi_ddr(GPIO)           \
    __asm__ volatile ("cbi %0, %1" :: "I" (_DDR_ADDRESS(GPIO) - __SFR_OFFSET), "I" (GPIO & _GPIO_PIN_MASK))
#define sbi_port(GPIO)          \
    __asm__ volatile ("sbi %0, %1" :: "I" (_PORT_ADDRESS(GPIO) - __SFR_OFFSET), "I" (GPIO & _GPIO_PIN_MASK))
#define cbi_port(GPIO)          \
    __asm__ volatile ("cbi %0, %1" :: "I" (_PORT_ADDRESS(GPIO) - __SFR_OFFSET), "I" (GPIO & _GPIO_PIN_MASK))
#define sbi_pin(GPIO)           \
    __asm__ volatile ("sbi %0, %1" :: "I" (_PIN_ADDRESS(GPIO) - __SFR_OFFSET), "I" (GPIO & _GPIO_PIN_MASK))
