...
#define SEGMENT_dp      _PA7
#define SEGMENT_g       _PA6
#define SEGMENT_f       _PA5
#define SEGMENT_e       _PA4
#define SEGMENT_d       _PA3
#define SEGMENT_c       _PA2
#define SEGMENT_b       _PA1
#define SEGMENT_a       _PA0

/*
 * Addresses of DDRx, PORTx and PINx registers have the same offset of 3.
 * It is useful for determining a real register address during a bit manipulation
 * 
 * PINA:0x00;  PINB:0x03;  PINC:0x06;  PIND:0x09     -> offset = 3U
 * DDRA:0x01;  DDRB:0x04;  DDRC:0x07;  DDRD:0x0a     -> offset = 3U
 * PORTA:0x02; PORTB:0x05; PORTC:0x08; PORTD:0x0b    -> offset = 3U
 * 
 * Port A will be a starting point for determining adвresses of direction, port, and pin registers for other ports (B, C, and D)
 */
 ...
 */
#define _GPIO_PIN_BIT(GPIO)     ((uint8_t)1U << ((GPIO) & _GPIO_PIN_MASK))
